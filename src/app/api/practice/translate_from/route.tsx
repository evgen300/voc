...
export async function GET(req: NextRequest) {
  ...
  await dbConnect();
  const test = await Word.getTranslateFromTest({ project_id: project_id || "", limit: limit });
...
export async function POST(req: NextRequest) {
  ...
  const result = await Word.validateFromTest(requestData.test, requestData.project_id);
